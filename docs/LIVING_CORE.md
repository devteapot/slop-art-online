...
- An exchange stops when someone ends it or stays silent, when a line gets "No answer" (out of earshot), or after 8 turns; it resets after 90 s of quiet. A line from outside the exchange (a deliberation, a human) reopens a finished one. Turns answer after the other's line has had time to be said (about 3 words a second, 1.5–8 s).
