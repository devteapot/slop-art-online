...
| --- | --- | --- |
| [1. Viable settlement](STAGE_1_EVIDENCE.md) | Four-person renewable provisioning beyond initial supplies and failure controls. | Arbitrary-world sustainability. |
| [2. Teaching and physical archives](STAGE_2_EVIDENCE.md) | Chosen transfer, post-death acquisition, learning-to-action and exact copy/loss/privacy checks. | Broad distribution and practical mastery. |
| [3. Population renewal](STAGE_3_EVIDENCE.md) | Paid fabrication, biological consent controls, dependent identities, real newcomer inference, care and guided harvesting. | Autonomous biological completion and sustained independent provisioning. |
| [4. Connected societies](STAGE_4_EVIDENCE.md) | Contact, travel, provisioning away from home and interpreted inter-camp communication. | Delivered aid, reciprocal trade and stable migration. |
| [5. First faction world](STAGE_5_EVIDENCE.md) | Physical utilities, body charging, paid queued computation and a 36-person live seed. | Stable provisioning, useful compute allocation and sustained 20 Hz. |
| [6. Numerical research](STAGE_6_EVIDENCE.md) | Autonomous paid prototype, own-code assessment/practice/use and exact communicated-learning authority checks. | The autonomous useful-method → peer practice → peer use chain remains unachieved. |
| [7. Scoped and universal laws](STAGE_7_EVIDENCE.md#acceptance-decision-bounded-stage-7-implementation-milestone) | Paid exact-source personal practice, shared authority, territorial scope, taught-code universal installation and persistence after installer death; completed faction integration. | Autonomous law discovery and universal ascension remain unproven. |

[Campaign 028](SOCIETY_BATCH_028.md) completes the latest finite scale integration with 36 original people and 34 survivors. Its explicit persistent external connections, eight RPC permits and stopped-host finalization pass the predeclared late-access and original cleanup requirements. All seven final invariant reports pass, all 43 retained databases verify paused or empty with zero grants, and owned model/host processes stop. The dedicated test service is subsequently stopped; its separate forced-stop limitation is retained in the report. The original final snapshot contains 66,926 contiguous events. Earlier campaigns 025/026, the unlaunched 027 plan, access timeouts, OOM and fixture failures remain separate evidence.

The [Stage 7 report](STAGE_7_EVIDENCE.md) preserves dated validation sets, the four twenty-four-minute autonomous law worlds with no law attempts, actual participant-interface capability/persistence diagnostics, storage/privacy/owner-export checks and resource measurements. A bounded implementation pass does not establish the complete world vision, sustainable large societies or long-term service capacity. Earlier implementation sections below are historical.
