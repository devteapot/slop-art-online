...
pub trait equip_item {
    ...
    fn equip_item(&self, inventory_item_id: u64) -> __sdk::Result<()> {
        self.equip_item_then(inventory_item_id, |_, _| {})
    }
...
impl equip_item for super::RemoteReducers {
    fn equip_item_then(
        ...
        self.imp
            .invoke_reducer_with_callback(EquipItemArgs { inventory_item_id }, callback)
    }
}
