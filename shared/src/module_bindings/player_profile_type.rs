...
pub struct PlayerProfileCols {
    ...
    pub display_name: __sdk::__query_builder::Col<PlayerProfile, String>,
    pub created_at: __sdk::__query_builder::Col<PlayerProfile, u64>,
    pub updated_at: __sdk::__query_builder::Col<PlayerProfile, u64>,
}
