...
pub trait unequip_item {
    ...
    fn unequip_item(&self, equipped_item_id: u64) -> __sdk::Result<()> {
        self.unequip_item_then(equipped_item_id, |_, _| {})
    }
...
impl unequip_item for super::RemoteReducers {
    fn unequip_item_then(
        ...
        self.imp
            .invoke_reducer_with_callback(UnequipItemArgs { equipped_item_id }, callback)
    }
}
