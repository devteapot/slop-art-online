...
/// Generic controller orientation, independent of any particular scenario or desired outcome.
pub const SELF_DIRECTION_GUIDANCE: &str = "Consider what, if anything, is worth doing now given your motives and what your own evidence shows has changed or been completed. Continuing, reconsidering a goal, choosing another activity, and doing nothing are valid choices; use only this turn's permitted operations.";
